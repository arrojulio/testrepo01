<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Bladex.Garantias.Presentation.Website.ViewModels.GarantiaInmuebleViewModel>" %>
...
<script type="text/javascript">
    var backUrl = '<%= Url.Action("Index","GarantiaInmueble", new { categoriaSuperId = "02" }) %>';
