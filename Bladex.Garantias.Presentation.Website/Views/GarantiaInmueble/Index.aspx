<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<System.Collections.Generic.List<Bladex.Garantias.DomainModel.DomainBase.GarantiaInmueble>>" MasterPageFile="~/Views/Shared/Site.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Listado de Garantías Hipotecarias Inmuebles
</asp:Content>
    ...
    <table id="tblGarantiasList" cellspacing="0" cellpadding="5">
        <thead>
            <tr>
                ...
                <th>Valor Inicial</th>
                <th>Valor de Avalúo de la Finca</th>
                <th>Action</th>
            </tr>
        </thead>
        <tbody>
        <%foreach(var garantia in Model){ %>
            <% Html.RenderPartial("DisplayTemplates/GarantiaInmuebleTableRow", garantia as Bladex.Garantias.DomainModel.DomainBase.GarantiaBase);%>
        <%} %>
        </tbody>
    </table>
    <div>
