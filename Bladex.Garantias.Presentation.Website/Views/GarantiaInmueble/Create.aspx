<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<Bladex.Garantias.Presentation.Website.ViewModels.GarantiaInmuebleViewModel>" MasterPageFile="~/Views/Shared/Site.Master" %>
            ...
            <table id="tblGarantia" class="guaranteeTable" cellpadding="0" cellspacing="0">            
                <tbody>    
                    ...
                    <tr class="guaranteeRow">
                        ...
                        <td>
                            <div class="editor-field">
                                <%: Html.DisplayFor(model => model.Garantia.IdentificacionDocumentoGarantia)%>
                    ...
                    <tr class="guaranteeRow">
                        ...
                        <td>
                            <div class="editor-field">
                                <%--<%: Html.EditorFor(model => model.Garantia.OrigenGarantia.OrderBy(x=>x.ToString()))%>--%>
                    ...
                    <tr class="guaranteeRow">
                        ...
                        <td>
                            <div class="editor-field">
                                ...
                                <label id="lblValidation_Garantia_NumeroPoliza" class="field-validation-error"></label>
                            </div>
                        </td>
                    </tr>        
                    <tr class="guaranteeRow">
                    ...
                    <td>
                        <div class="editor-label">
                            <%: Html.LabelTooltipFor(model => model.Garantia.InscripcionRegistroPublico)%>
                        </div>
                    </td>
                    <td>
                        <div class="editor-field">
                            <%: Html.EditorFor(model => model.Garantia.InscripcionRegistroPublico)%>
                            <%: Html.ValidationMessageFor(model => model.Garantia.InscripcionRegistroPublico)%>
                        </div>
                    </td>
                </tr>
                <tr class="guaranteeRow">
                    <td>
                        <div class="editor-label">
                            <%: Html.LabelTooltipFor(model => model.Garantia.NumeroDeFinca)%>
                        </div>
                    </td>
                    <td>
                        <div class="editor-field">
                            <%: Html.EditorFor(model => model.Garantia.NumeroDeFinca)%>
                            <%: Html.ValidationMessageFor(model => model.Garantia.NumeroDeFinca)%>
                        </div>
                    </td>
                    </tr>
                     <tr class="guaranteeRow">
                        <td>
                            <div class="editor-label">
                                <%: Html.LabelTooltipFor(model => model.Garantia.ValorAvaluo)%>
                            </div>
                        </td>
                        <td>
                            <div class="editor-field">
                                <%: Html.EditorFor(model => model.Garantia.ValorAvaluo)%>                                
                                <label id="lblGarantia_ValorAvaluo_Validation" class="field-validation-error"></label>
                            </div>
                        </td>
                    </tr>
                     ...
                     <tr class="guaranteeRow">
                        <td>
                            <div class="editor-label">
                                <%: Html.LabelTooltipFor(model => model.Garantia.ValorEvaluacionVentaRapida)%>
                            </div>
                        </td>
                        <td>
                            <div class="editor-field">
                                <%: Html.EditorFor(model => model.Garantia.ValorEvaluacionVentaRapida)%>                                
                                <label id="lblGarantia_ValorVentaRapida_Validation" class="field-validation-error"></label>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr class="guaranteeRow">
                        <td>
                            <div class="editor-label">
                                <%: Html.LabelTooltipFor(model => model.Garantia.AseguradorSuper)%>
                            </div>
                        </td>
                        <td>
                            <div class="editor-field">
                                <%: Html.EditorFor(model => model.Garantia.AseguradorSuper)%>      
                                <%: Html.ValidationMessageFor(model => model.Garantia.AseguradorSuper.Key)%>                          
                                <label id="lblValidation_Garantia_AseguradorSuper" class="field-validation-error"></label>                                
                            </div>
                        </td>
                    </tr>
                     <tr class="guaranteeRow">
