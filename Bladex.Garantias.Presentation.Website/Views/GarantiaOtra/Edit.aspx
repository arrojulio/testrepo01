<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Bladex.Garantias.Presentation.Website.ViewModels.GarantiaOtraViewModel>" %>
...
<script type="text/javascript">
    var backUrl = '<%= Url.Action("Index","GarantiaOtra", new { categoriaSuperId = "06" }) %>';
    logInBrowser(backUrl);
</script>
    <h2>Editar <%:ViewData["CategoriaSuperTitle"]%></h2>
    <%this.ViewData["GarantiaBase.Key"] = Model.Garantia.Key; %>
    <script type="text/javascript">
                ...
                <tbody>    
                    ...
                    <tr class="guaranteeRow">
                      ...
                      <tr class="guaranteeRow">
                        <td>
                            <div class="editor-label">                               
                                <%: Html.LabelTooltipFor(model => model.Garantia.NroReferencia, "Ref. Otra Garantia")%>

                            </div>
                        </td>
                        <td>
                            <div class="editor-field">
                                <%: Html.EditorFor(model => model.Garantia.NroReferencia)%>                                
                                <%: Html.ValidationMessageFor(model => model.Garantia.NroReferencia)%>
                                <label id="lblValidation_Garantia_NroReferencia" class="field-validation-error"></label>                                       
                            </div>
                        </td>
                    </tr>                               
                    <tr class="guaranteeRow">
                    ...
                    <tr class="guaranteeRow">
                     ...
                     <tr class="guaranteeRow">
                        <td>
                            <div class="editor-label">
                                <%= Html.LabelTooltipFor(m=>m.Garantia.AvalComponent) %>
                            </div>
                        </td>
                        <td>
                            <div class="editor-field">                            
                                <%:Html.HiddenFor(model => model.Garantia.AvalComponent.hiddenAvales)%>                
                                <%= Html.EditorFor(m => m.Garantia.AvalComponent)%>                               
                            </div>
                        </td>
                    </tr>   
                     <tr class="guaranteeRow">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btnVerContratos").click(function () {
                ...
                var model = '<%= Html.Raw(Json.Encode(((Bladex.Garantias.Presentation.Website.Models.GarantiaOtraModel)(Model.Garantia))))%>';
