<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<Bladex.Garantias.Presentation.Website.ViewModels.GarantiaDepositoOtroBancoViewModel>" MasterPageFile="~/Views/Shared/Site.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%: Html.HiddenFor(m => m.BancoSuperSelected)%>
        ...
        <fieldset>                     
            <table id="tblGarantia" class="guaranteeTable" cellpadding="0" cellspacing="0">            
                <tbody>    
                    ...
                    <tr class="guaranteeRow">
                        ...
                        <td>
                            <div class="editor-label">
                                ...
                                <%: Html.LabelTooltipFor(model => model.Garantia.NumeroPolizaSeguro, "Ref. Deposito Otro Banco")%>
                            </div>
                        </td>
                        <td>
                            <div class="editor-field">
                    ...
                    <td>
                        <div class="editor-label">
                            <%: Html.LabelTooltipFor(model => model.Garantia.BancoSuper)%>
                        </div>
                    </td>
                    <td>
                        <div class="editor-field">
                            <%: Html.EditorFor(model => model.Garantia.BancoSuper)%>
                            <%: Html.ValidationMessageFor(model => model.Garantia.BancoSuper.Key)%>
                        </div>
                    </td>
                </tr>   
                <tr class="guaranteeRow">
