<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Bladex.Garantias.Presentation.Website.ViewModels.GarantiaPrendaViewModel>" %>
...
<script type="text/javascript">
    var backUrl = '<%= Url.Action("Index","GarantiaPrenda", new { categoriaSuperId = "05" }) %>';
    ...
    <%using (Html.BeginForm()) {%>
        <%--<%:Html.EditorFor(m => m, this.Model.Garantia)%>--%>
                ...
                <tbody>    
                      ...
                      <tr class="guaranteeRow">
                        ...
                        <td>
                            <div class="display-field">
                                ...
                                <label id="lblValidation_Garantia_Depositante_Key" class="field-validation-error"></label>
                            </div>                                                         
                        </td>
                    </tr>                    
                    <tr class="guaranteeRow">
                        ...
                        <td>
                            <div class="editor-field">
                                <%= Html.Telerik().DropDownListFor(m=>m.Garantia.OrigenGarantia)
                    ...
                    <tr class="guaranteeRow">
                     ...
                     <tr class="guaranteeRow">
                        ...
                        <td>
                            <div class="editor-field">
                                <%: Html.EditorFor(model => model.Garantia.ValorMercado)%>
                    ...
                    <!--- Specialization Fields -->                
                     <tr class="guaranteeRow">
                        <td>
                            <div class="editor-label">
                                <%= Html.LabelTooltipFor(model => model.Garantia.IdentificadorPrenda)%>
                            </div>
                        </td>
                        <td>
                            <div class="editor-field">
                                <%= Html.EditorFor(model => model.Garantia.IdentificadorPrenda)%>
                                <%= Html.ValidationMessageFor(model => model.Garantia.IdentificadorPrenda)%>
                            </div>
                        </td>
                    </tr>
                    <tr class="guaranteeRow">
                        <td>
                            <div class="editor-label">
                                <%= Html.LabelTooltipFor(model => model.Garantia.Emisor)%>
                            </div>
                        </td>
                        <td>
                            <div class="editor-field">
                                <%= Html.EditorFor(model => model.Garantia.Emisor)%>
                                <%= Html.ValidationMessageFor(model => model.Garantia.Emisor.Key)%>
                    ...
                    <tr class="guaranteeRow">
                        <td>
                            <div class="editor-label">
                                <%= Html.LabelTooltipFor(model => model.Garantia.TipoInstrumentoFinanciero)%>
                            </div>
                        </td>
                        <td>
                            <div class="editor-field">
                                <%= Html.EditorFor(model => model.Garantia.TipoInstrumentoFinanciero)%>
                                <%= Html.ValidationMessageFor(model => model.Garantia.TipoInstrumentoFinanciero.Key)%>
                    ...
                    <tr class="guaranteeRow">
                        <td>
                            <div class="editor-label">
                                <%= Html.LabelTooltipFor(model => model.Garantia.CalificacionesRiesgoEmision) %>
                            </div>
                        </td>
                        <td>
                            <div class="editor-field">
                                <%= Html.EditorFor(model => model.Garantia.CalificacionesRiesgoEmision)%>
                                <%= Html.ValidationMessageFor(model => model.Garantia.CalificacionesRiesgoEmision.Key)%>
                    ...
                    <tr class="guaranteeRow">
                        <td>
                            <div class="editor-label">
                                <%= Html.LabelTooltipFor(model => model.Garantia.CalificacionesRiesgoEmisor) %>
                            </div>
                        </td>
                        <td>
                            <div class="editor-field">
                                <%= Html.EditorFor(model => model.Garantia.CalificacionesRiesgoEmisor)%>
                                <%= Html.ValidationMessageFor(model => model.Garantia.CalificacionesRiesgoEmisor.Key)%>
                    ...
                    <tr class="guaranteeRow">
                        <td>
                            <div class="editor-label">
                                <%=Html.LabelTooltipFor(model=>model.Garantia.PaisEmision) %>
                            </div>
                        </td>
                        <td>
                            <div class="editor-field">
                                <%=Html.EditorFor(model=>model.Garantia.PaisEmision) %>
                                <%=Html.ValidationMessageFor(model=>model.Garantia.PaisEmision.Key) %>
                            </div>
                        </td>
                    </tr>
                    <tr class="guaranteeRow">
                ...
                <tr class="guaranteeRow">
                    ...
                    <td>
                        <div class="editor-field">
                            ...
                            <%: Html.DisplayFor(m => m.Garantia.FechaProximaRevisionEvaluacion)%>
                        </div>
                    </td>
                </tr>
                <tr class="guaranteeRow">
