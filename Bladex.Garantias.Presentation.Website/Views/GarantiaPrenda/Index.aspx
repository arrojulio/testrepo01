<%@ Page Title="" Language="C#" Inherits="System.Web.Mvc.ViewPage<System.Collections.Generic.List<Bladex.Garantias.DomainModel.DomainBase.GarantiaPrenda>>" MasterPageFile="~/Views/Shared/Site.Master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Listado de Garantías Prendarias
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table id="tblGarantiasList" cellspacing="0" cellpadding="5">
        ...
        <%foreach(var garantia in Model){ %>
            <%Html.RenderPartial("DisplayTemplates/GarantiaPrendaTableRow", garantia as Bladex.Garantias.DomainModel.DomainBase.GarantiaBase);%>
        <%} %>
        </tbody>
    </table>
    <div>
