<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Bladex.Garantias.Presentation.Website.ViewModels.GarantiaDepositoViewModel>" %>
...
<script type="text/javascript">
    var backUrl = '<%= Url.Action("Index","GarantiaDeposito", new { categoriaSuperId = "03" }) %>';
            ...
            <table id="tblGarantia" class="guaranteeTable" cellpadding="0" cellspacing="0">            
                <tbody>    
                    ...
                    <tr class="guaranteeRow">
                        ...
                        <td>
                            <div class="display-field">
                                <%:Html.EditorFor(m => m.Garantia.Garante)%></div>
                        </td>
                    </tr>
                    <tr class="guaranteeRow">
                        <td>
                    ...
                    <td>
                        <div class="editor-label">
                            <%: Html.LabelTooltipFor(model => model.Garantia.BancoLocalSuper)%>
                        </div>
                    </td>
                    <td>
                        <div class="editor-field">
                            <%: Html.EditorFor(model => model.Garantia.BancoLocalSuper)%>
                        </div>
                    </td>
                </tr>             
                     <tr class="guaranteeRow">
