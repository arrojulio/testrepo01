...
{
    internal class GarantiaMuebleFactory : IEntityFactory<Bladex.Garantias.DomainModel.DomainBase.GarantiaMueble> 
    {
        #region Field Names
        ...
        public DomainModel.DomainBase.GarantiaMueble BuildEntity(System.Data.IDataReader reader)
        {
            ...
            DomainModel.DomainBase.GarantiaMueble garantia = AutoMapper.Mapper.Map<DomainModel.DomainBase.GarantiaBase, DomainModel.DomainBase.GarantiaMueble>(garantiaBase);
