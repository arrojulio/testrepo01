...
using Bladex.Garantias.Infrastructure.Repositories.GrupoRiesgoGarantia;

namespace Bladex.Garantias.Infrastructure.Repositories.GrupoRiesgoGarantia
{
    public class GrupoRiesgoGarantiaSqlRepository : SqlRepositoryBase<DomainModel.DomainBase.GrupoRiesgoGarantia>, IGrupoRiesgoGarantiaRepository
    {
        ...
        public GrupoRiesgoGarantiaSqlRepository()
            : this(null)
        {
        }

        public GrupoRiesgoGarantiaSqlRepository(IUnitOfWork unitOfWork)
            : base(unitOfWork)
        {
        ...
        {
            DomainModel.DomainBase.GrupoRiesgoGarantia grupoRiesgoGarantia = item as DomainModel.DomainBase.GrupoRiesgoGarantia;
            if (grupoRiesgoGarantia != null)
            {
                return this.PersistNewItem(grupoRiesgoGarantia);
            }
        ...
        public override EntityBase PersistUpdatedItem(EntityBase item)
        {
            ...
            if (grupoRiesgoGarantia != null)
            {
                return this.PersistUpdatedItem(grupoRiesgoGarantia);
            }
            // TODO: We should throw some exception here if the cast is not valid.
            return item;
        }
        ...
        public override void PersistDeletedItem(EntityBase item)
        {
            ...
            if (grupoRiesgoGarantia != null)
            {
                this.PersistDeletedItem(grupoRiesgoGarantia);
            }
            // TODO: We should throw some exception here if the cast is not valid.
        }

        protected override DomainModel.DomainBase.GrupoRiesgoGarantia PersistNewItem(DomainModel.DomainBase.GrupoRiesgoGarantia item)
        {
            StringBuilder builder = new StringBuilder();

            builder.Append(string.Format("INSERT INTO {0} ({1},{2}) ",
                this.GetEntityName(),
                GrupoRiesgoGarantiaFactory.FieldNames.GrupoRiesgoGarantiaId,
                GrupoRiesgoGarantiaFactory.FieldNames.GrupoRiesgoGarantiaName));
        ...
        protected override DomainModel.DomainBase.GrupoRiesgoGarantia PersistUpdatedItem(DomainModel.DomainBase.GrupoRiesgoGarantia item)
        {
            StringBuilder builder = new StringBuilder();
        ...
        protected override void PersistDeletedItem(DomainModel.DomainBase.GrupoRiesgoGarantia item)
        {
        ...
        {
            return GrupoRiesgoGarantiaFactory.FieldNames.GrupoRiesgoGarantiaId;
        }
    }
}